...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    List<Reservation> findAllReservationsForCalendar(@Param("status") @Param("startDate") String startDate, @Param("endDate") String endDate);
    ...
    List<Reservation> findGroupReservationsForCalendar(@Param("group") Boolean group, @Param("status") @Param("startDate") String startDate, @Param("endDate") String endDate);
